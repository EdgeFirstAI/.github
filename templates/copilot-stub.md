# AI assistant guidelines — PROJECT_NAME
...
Keep this file for project-specific notes only (workspace layout, test commands, hardware, platform `cfg`). Do not duplicate branch/commit/PR/release rules here.
