...
This is the EdgeFirstAI code of conduct. It governs every repository in the
organisation and every space the organisation runs, and it is not something an
individual project sets aside. A repository that carries its own copy is
carrying a copy by convention, for the benefit of anyone reading that
repository on its own — the policy is this one.
...
- **Report privately on GitHub**: open the repository's **Security** tab and choose *Report a vulnerability*. Private reporting is the right channel for a conduct report as well as a security one — it reaches the maintainers without being public.
